...
function Veg() {
  ...
  let itemsPerPage = 8;
  let totalPages = Math.ceil(vegItems.length / itemsPerPage);

  // Slice data for current page
  let indexOfLastItem = currentPage * itemsPerPage;
  let indexOfFirstItem = indexOfLastItem - itemsPerPage;
  let currentItems = vegItems.slice(indexOfFirstItem, indexOfLastItem);

  return (
  <>  
    <div className="container veg-items">
      
       {/* ✅ Toast container (always mounted once) */}
      <ToastContainer position="top-right" autoClose={3000} />

      <h2 className="mb-4 text-center fw-bold">VEG ITEMS</h2>
      <div className="row">
