...
function NonVeg() {
  const nonVegItems = useSelector(state => state.product.nonVegItems);
  ...
  return (
    <>
        <div className=" container nonveg-items">

          {/* ✅ Toast container (always mounted once) */}
          <ToastContainer position="top-right" autoClose={3000} />

          <h2 className="mb-4 text-center fw-bold">🍗 NON-VEG ITEMS</h2>
